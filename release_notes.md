...
- Fix branch build ID verification so currently installed beta/alternative branch installations correctly resolve and display their action button as "Verify Files" (green) rather than prompting to install.
